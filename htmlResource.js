function newItemsIntro() {
	return `<style type="text/css">
			...
			<div class="publish-container">  <img alt="" class="" style="display: block; height: auto; max-width: 100%;" width="280" border="0" hspace="0" vspace="0" src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f0/Plex_vector_logo.svg/1280px-Plex_vector_logo.svg.png">
			</div>
			</td>
			</tr>
			</tbody>
			...
			<div></div>
			<div class="text-container galileo-ap-content-editor"><div><div>Deep Media PlexBot New Items!</div></div></div>
			</td>
			</tr>
			</tbody>
			</table>
...
function newItemsEnd() {
	return `<table width="100%" cellpadding="0" cellspacing="0" border="0" class="galileo-ap-layout-editor" style="min-width: 100%;">
			...
			<tr>
			<td align="center" valign="top" style="padding-top: 10px; padding-bottom: 10px;">
			<div class="publish-container">  <img alt="" class="" style="display: block; height: auto; max-width: 100%;" width="166" border="0" hspace="0" vspace="0" src="https://botsfordiscord.com/img/error/3.png">
			</div>
			</td>
			</tr>
			</tbody>
			...
			<div></div>
			<div class="text-container galileo-ap-content-editor"><div><div>Contact Us</div></div></div>
			</td>
			</tr>
			</tbody>
			</table>
			...
			<div><span style="font-size: 16px;">For movie and show requests please contact us here:</span></div>
			<div><br></div>
			<div><a href="mailto:DeepMedia.PlexBot@gmail.com" target="_blank" style="font-size: 16px; color: #48a199; font-weight: normal; font-style: normal; text-decoration: underline;">DeepMedia.PlexBot@gmail.com</a></div>
			</div></div>
			</td>
			</tr>
			</tbody>
...
function newMoviesStart() {
	return `<table width="100%" cellpadding="0" cellspacing="0" border="0" class="galileo-ap-layout-editor" style="min-width: 100%;">
			...
			<div></div>
			<div class="text-container galileo-ap-content-editor"><div><div><span style="color: rgb(0, 0, 0);">Movies</span></div></div></div>
			</td>
			</tr>
			</tbody>
			</table>
...
function newShowsStart() {
	return `<table width="100%" cellpadding="0" cellspacing="0" border="0" class="galileo-ap-layout-editor" style="min-width: 100%;">
			...
			<div></div>
			<div class="text-container galileo-ap-content-editor"><div><div><span style="font-size: 16px; color: rgb(0, 0, 0); font-weight: bold;">Shows</span></div></div></div>
			</td>
			</tr>
			</tbody>
			</table>
...
function newShowsMiddle() {
	return `</td>
		...
		<td class="editor-text article-heading-text" align="left" valign="top" style="font-family: Arial, Verdana, Helvetica, sans-serif; font-size: 16px; color: #717a80; text-align: left; display: block; word-wrap: break-word; line-height: 1.2; font-weight: bold; padding: 10px 20px;">
		<div></div>
		<div class="text-container galileo-ap-content-editor"><div><div><span style="font-size: 14px; color: rgb(207, 143, 18);">New Shows</span></div></div></div>
		</td>
		</tr>
		</tbody>
		</table>
